...
electron_1.contextBridge.exposeInMainWorld('vaultSync', {
    ...
    pickAdditionalSyncFolder: () => electron_1.ipcRenderer.invoke('pick-additional-sync-folder'),
    addAdditionalSyncFolder: (localPath) => electron_1.ipcRenderer.invoke('add-additional-sync-folder', localPath),
    removeAdditionalSyncFolder: (folderId) => electron_1.ipcRenderer.invoke('remove-additional-sync-folder', folderId),
    resolveLocalPath: (storedRelPath) => electron_1.ipcRenderer.invoke('resolve-local-path', storedRelPath),
